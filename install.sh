...
sudo pacman -Rns --noconfirm baobab cheese eog epiphany gnome-backgrounds \
    ...
    gnome-remote-desktop nautilus gnome-text-editor gnome-software \
...
sudo pacman -S --noconfirm --needed base-devel ufw neofetch firefox \
    ...
    bleachbit man-db man-pages shotcut python-pywal tmux gnome-themes-extra bc maim \
...
yay -S --noconfirm --sudoloop --answerclean All --answerdiff None --removemake \
    ...
    inxi-git gnome-shell-extension-rounded-window-corners-git

# additional extensions: panel date format, krypto, disable workspace switcher
